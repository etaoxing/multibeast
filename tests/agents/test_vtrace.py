# from https://github.com/facebookresearch/minihack/blob/65fc16f0f321b00552ca37db8e5f850cbd369ae5/minihack/agent/polybeast/core/vtrace_test.py
...
@unittest.skip("multibeast does not use vtrace.action_log_probs")
...
class VtraceTest(unittest.TestCase):
    ...
    @unittest.skip("multibeast does not use vtrace.from_logits")
    def test_vtrace_from_logits(self, batch_size=2):
        ...
        print(values["behavior_policy_logits"].shape, values["target_policy_logits"].shape, values["actions"].shape)
